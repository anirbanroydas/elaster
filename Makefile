APP_NAME = elaster
PROJECT_NAME = elaster

UNIT_TESTING_NAME = elasterunit
CONTRACT_TESTING_NAME = elastercontract
INTEGRATION_TESTING_NAME = elasterintegration
COMPONENT_TESTING_NAME = elastercomponent
END_TO_END_TESTING_NAME = elastere2e
...
DATA_VOLUME_NAME = $(PROJECT_NAME)_elasticsearch_data_volume
